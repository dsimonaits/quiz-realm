...
export const QuizData: IQuiz[] = [
  ...
  },
  {
    ...
    fakeAnswer1: "There is no difference between forEach() and map() methods.",
    fakeAnswer2:
  ...
  },
  {
    ...
    fakeAnswer3: "An object method is a way to define variables in JavaScript.",
  },
  {
    id: 12,
    category: "React",
  ...
  },
  {
    ...
    fakeAnswer1: "The 'fs' module is used for creating web servers in Node.js.",
    fakeAnswer2:
  ...
  },
  {
    ...
    fakeAnswer1: "The 'os' module is used for creating web servers in Node.js.",
    fakeAnswer2:
      "The 'os' module is used for handling file operations in Node.js.",
    fakeAnswer3: "The 'os' module is used for rendering web pages in Node.js.",
  },
  {
    id: 27,
    category: "NodeJS",
  ...
  },
  {
    ...
    fakeAnswer3: "The 'url' module is used for rendering web pages in Node.js.",
  },
  {
    id: 31,
    category: "MongoDB",
    ...
    fakeAnswer2: "A MongoDB query is used to create new databases in MongoDB.",
    fakeAnswer3:

...
import { Button, HStack, Heading, Highlight, Text } from "@chakra-ui/react";
    ...
    <Section>
      <MainContainer>
        ...
        <Text my="10px">
          ...
          >
            Hi, I'm Deniss Siomnaits, the creator of QuizRealm | JS and Beyond.
          </Highlight>
        </Text>
        ...
        <Text>
          ...
          the pursuit of knowledge. Whether you're a student, a professional, or
          simply someone curious about the world, this app is designed to help
          you on your path of continuous learning.
        </Text>
        ...
        <Text mt="5px">
          ...
          building user interfaces. This modern and efficient technology allows
          us to deliver a seamless and responsive learning experience.
        </Text>
        <Text mt="5px">

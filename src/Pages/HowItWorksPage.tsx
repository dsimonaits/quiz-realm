  ...
  return (
    <Section>
      <MainContainer>
        ...
        <Text mt="5px">
          When you first launch the app, you'll see a "Start Learning" button at
          Quiz page. Clicking on it will start your learning journey.
        </Text>
        ...
        <Text mt="5px">
          Now, you'll start your learning journey. The app will present you with
          quizzes related to the category and topics you've chosen. Your task is
        ...
        <Text mt="5px">
          For each quiz question, you'll see multiple answer options. Choose the
          correct answer to move on to the next question.
        </Text>
